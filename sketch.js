...
objetivo = loadImage("assets/objetivo.png")
}
...
bar = createSprite(400,200,20,20);
bar.visible=false;
}
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    // Agregando gravedad
     balloon.velocityY = balloon.velocityY + 1.25;
...
function spawnObstaclesBottom() 
{
 ...
 function Bar() 
 {
         if(World.frameCount % 60 === 0)
         {
           var bar = createSprite(400,200,20,20);
           bar.addImage("objetivo1",objetivo);
           bar.scale = 0.1
          bar.velocityX = -6
          var barY = Math.round(random(10,200));
          //anexar animacion de moneda
          bar.y = barY
          //coloca de manera aleatoria pocicion Y (arreglar puntuacion)
          bar.velocityX = -6
